...
class VisTrack:
    ...
    def draw_bounding_boxes(self, im: PIL.Image, bboxes: np.ndarray, ids: np.ndarray,
                        scores: np.ndarray, text_w, text_h, font_size=20) -> PIL.Image:
        """
        ...
        font = PIL.ImageFont.truetype("/Users/nathanchen/Library/Group Containers/UBF8T346G9.Office/FontCache/4/CloudFonts/Segoe UI/33157173603.ttf", font_size)
